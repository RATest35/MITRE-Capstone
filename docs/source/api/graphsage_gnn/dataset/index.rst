graphsage_gnn.dataset
=====================

.. py:module:: graphsage_gnn.dataset
...
.. autoapisummary::
   ...
   graphsage_gnn.dataset.GraphDataset
   graphsage_gnn.dataset.SamplerConfig
   graphsage_gnn.dataset.RootedSubgraphDataset
...
.. autoapisummary::
   ...
   graphsage_gnn.dataset.load_graph_dataset
   graphsage_gnn.dataset.standardize_features
   graphsage_gnn.dataset.subnet_group_split
...
.. py:class:: GraphDataset
   ...
   :ivar in_neighbors: Incoming neighbors and edge flow values.
   :ivar out_neighbors: Outgoing neighbors and edge flow values.
   ...
   .. py:attribute:: in_neighbors
      :type:  list[list[tuple[int, float]]]
...
.. py:function:: load_graph_dataset(graphml_path: pathlib.Path, split_prefix_len: int = 2) -> GraphDataset
